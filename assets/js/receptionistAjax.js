    ...
    xhttp.onreadystatechange = function () {
        if (xhttp.readyState === 4) {
            if (xhttp.status === 200) {
                ...
                document.getElementById("roomStatusResult").innerHTML = output;
            } else {
                document.getElementById("roomStatusResult").innerHTML = "<p>AJAX request failed.</p>";
            }
        }
    };

    xhttp.open("GET", "index.php?route=ajax-receptionist-room-status", true);
    xhttp.send();
}